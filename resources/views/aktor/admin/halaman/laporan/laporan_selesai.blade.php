                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="w-100">
                                                        <h5 class="m-0 fs-14">{{ ucwords($row->buku->judul) }} ({{ $row->buku->tahun_terbit }})</h5>
                                            ...
                                            <td>Rp. {{ number_format($row->denda_buku_rusak) }}</td>
                                            <td>Rp. {{ number_format($row->denda_buku_hilang) }}</td>
                                            <td>

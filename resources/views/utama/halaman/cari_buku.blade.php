            ...
            <div class="row d-flex">
                <div class="col-lg-3 col-md-4 col-12">
                    <div class="primary-sidebar text-left">
                        ...
                        <aside id="content-arrival" class="content-arrival d-none d-lg-block">
                                        ...
                                        <div class="product-thumb">
                                            <div class="image">
                                                <a href="{{ route('home.detailBuku', $row->slug) }}">
                                                    <img src="{{ asset('storage/sampul/'. $row->sampul) }}" alt="buku" class="img-fluid">
                                                </a>
                                            </div>
                                            <div class="caption">
                        ...
                        <div class="row d-flex">
                            <div class="col-12 col-sm-9 col-xl-5 col-lg-5 col-md-5">
                                <div class="toolbar-amount">
                                    ...
                                    @else
                                        <span>Menampilkan 0-0</span> dari {{ $buku->total() }} hasil
                                    @endif
                                </div>
                            </div>
                        </div>
